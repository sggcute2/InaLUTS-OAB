...
return new class extends Migration
{
    ...
    {
        Schema::create('oab_follow_up_terapi_operatif_injeksi_botox', function (Blueprint $table) {
            $table->id();
            ...
            $table->date('injeksi_botox_date')->nullable();
            $table->string('injeksi_botox_tindakan')->default('');
            //===[ /FIELDS ]====================================================
    ...
    {
        Schema::dropIfExists('oab_follow_up_terapi_operatif_injeksi_botox');
    }
};
