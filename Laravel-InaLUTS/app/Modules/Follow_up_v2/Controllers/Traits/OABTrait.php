...
namespace App\Modules\Follow_up_v2\Controllers\Traits;

use Illuminate\Http\RedirectResponse;
use Illuminate\Http\Request;
use Illuminate\View\View;
//use App\Modules\Follow_up_v2\Models\Follow_up_v2;
use App\Modules\Follow_up_v2\Controllers\Traits\OAB\{
    OAB_anamnesisTrait,
...
/*
use App\Modules\Follow_up_v2\Models\OAB\OAB_follow_up_pemeriksaan_laboratorium;
use App\Modules\Follow_up_v2\Models\OAB\OAB_follow_up_terapi_operatif_injeksi_botox;
*/
/*
...
trait OABTrait {
    ...
    public function _NOT_USED_detail_oab($pasien_id, $id): View
    {
    ...
    public function _NOT_USED_update_oab_process(
