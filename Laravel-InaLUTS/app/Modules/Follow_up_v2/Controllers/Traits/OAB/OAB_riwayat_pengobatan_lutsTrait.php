...
use App\Modules\Follow_up_v2\Models\OAB\OAB_riwayat_pengobatan_luts;
use BS;
use DT;
use FORMAT;

trait OAB_riwayat_pengobatan_lutsTrait {
    public function detail_oab_riwayat_pengobatan_luts($id, $follow_up_id): View
    {
        $pasien = $this->_allow_access($id);

        if (!OAB_riwayat_pengobatan_luts::where('pasien_id', $id)->where('follow_up_id', $follow_up_id)->exists()) {
            OAB_riwayat_pengobatan_luts::base_insert(['pasien_id' => $id, 'follow_up_id' => $follow_up_id]);
        }
    ...
    ): RedirectResponse
    {
        ...
        */
        ...
        OAB_riwayat_pengobatan_luts::base_update_by_pasien_id_and_follow_up_id(
        ...
        return redirect()->route(
            MODULE.'.detail_oab_riwayat_pengobatan_luts',
            ['id' => $id, 'follow_up_id' => $follow_up_id]
        );
    }
}
